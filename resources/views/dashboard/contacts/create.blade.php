    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">أضافة جة تواصل</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="userForm" enctype="multipart/form-data" action="{{route('admin.save_contact')}}" method="post">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3">
                   ...
                   <div class="mb-3">
                    ...
                    <br>
                    <label class="btn btn-primary btn-sm shadow-sm" for="photo"><i class="fas fa-image"></i> أختر صورة</label>
                   </div>  
        </div>
