  ...
  <div class="modal fade" id="addCat" tabindex="-1" aria-labelledby="createCatLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form enctype="multipart/form-data" class="userForm" action="{{route('admin.save_cat')}}" method="post">
        ...
        <div class="modal-body">
                ...
                <div class="mb-3">
                   ...
                   <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="fr_name" id="fr_name" aria-describedby="helpId" placeholder="">
                   </div>
                   <div class="mb-3">
                    <label for="photoEdit" class="form-label">صورة العرض</label>
                    <br>
                    ...
                    <br>
                    <label class="btn btn-primary btn-sm shadow-sm" for="photoEdit"><i class="fas fa-image"></i> أختر الصورة</label>
                   </div>
                   ...
                   <div class="mb-3">
                    ...
                    <textarea   class="form-control" name="fr_description" id="fr_description" aria-describedby="helpId" placeholder=""></textarea>
                   </div>
