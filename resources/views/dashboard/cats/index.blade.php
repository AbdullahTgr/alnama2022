...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800">الاقسام</h1>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a type="button"  data-bs-toggle="modal" data-bs-target="#addCat" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> أضافة</a>
        </div>
    <!-- DataTales Example -->
