                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-md-12 mb-12">
                              <div class="row">
                                <div class="col-md-3">
                                    <form style=" margin-top: 6%; " class="userForm" enctype="multipart/form-data" id="formCover" action="{{route('admin.update_cover')}}" method="post">
                                        @csrf
                                        <input  accept="image/png, image/gif, image/jpeg" type="file" name="cover" id="cover" style="display: none;">
                                        <label for="cover" class="btn btn-primary" href="#">صورة رؤية الشركة<i class="fa fa-image"></i></label>
                                      </form>
                                  </div>
                                  <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    <form  style=" margin-top: 6%; " class="userForm" enctype="multipart/form-data" id="formVideo" action="{{route('admin.update_video')}}" method="post">
                                        @csrf
                                        <input  accept="video/mp4" type="file" name="video" id="video" style="display: none;">
                                        <label for="video" class="btn btn-primary" href="#">فديوا الموقع الرئيسية<i class="fa fa-video"></i></label>
                                      </form>
                                  </div>
                                  <div class="col-md-3">
                                      <video style="width: 128px" class="img-fluid" src="{{asset( str_replace('public' , 'storage' ,$cover->video))}}" alt="" srcset=""></video>
                                  </div>
                              </div>
                            <hr>
                        </div>
