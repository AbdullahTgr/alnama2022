...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-2 text-gray-800">المنتجات</h1>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a type="button"  data-bs-toggle="modal" data-bs-target="#addProduct" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i>اضف </a>
        </div>
    <!-- DataTales Example -->
                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan="1" colspan="1">الاسم بالانجليزية</th>
                            <th rowspan="1" colspan="1">الوصف بالعربي</th>
                            <th rowspan="1" colspan="1">الوصف بالانجليزية</th>
