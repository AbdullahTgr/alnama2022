            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">اللوحة الرئيسية</h1>
                                            ...
                                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">الاسم بالعربي</th>
                                                         <th rowspan="1" colspan="1">الوصف بالعربي</th>
                                                         <th rowspan="1" colspan="1">الاجراء</th>
                                                     </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td class="sorting_1">{{$product->ar_name}}</td>
                                                         ...
                                                         <td>
                                                             <a href="{{route('admin.products')}}" class="btn btn-primary btn-sm"><i class="fa fa-shapes"></i>ادارة المنتجات</a>                                
                                                        </td>
                                                     </tr>
                                                    @empty
                                                        {{'No data to show.'}}
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">اذا اؤدت المغادرة سجل الخروج</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">الغاء</button>
                    <a class="btn btn-primary" href="login.html">سجل خروج</a>
                </div>
            </div>
        </div>
    </div>
