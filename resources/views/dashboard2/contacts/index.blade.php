...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">التواصل</h1>
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            <td class="sorting_1">
                                ...
                                <img style=" max-width: 45px; " src="{{asset( str_replace('public' , 'storage' ,$contact->photo))}}" class="img-fluid" srcset="">
                             </td>
                            <td>{{$contact->name}}</td>
                            <td>{{$contact->phone}}</td>
                            <td>{{$contact->link}}</td>
                            <td>
                                <div  type="button"  data-bs-toggle="modal" data-bs-target="#deleteProduct{{$contact->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</div>                                
                            </td>
                         </tr>
                        @empty
                            {{'No data to show.'}}
...
@foreach ($contacts as $contact)
 @include('dashboard.contacts.delete')
@endforeach
